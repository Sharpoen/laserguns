class guiV1{
  ...
  render_skins(){
    fill(255,255);
    textSize(20);
    text("inventory | settings | debug -> [skins]",width/16+20,height/16+20);
    fill(255);
    if(this.box(width/16+10,height/16+25,25,25)){
      fill(200);
      if(inputs["clickL"]){
        this.pagesOpen.debug=true;
        this.pagesOpen.skins=false;
      }
    }
    rect(width/16+10,height/16+25,25,25);
    fill(255);
    ...
    if(this.box(width/8,height/8,50,50)){
      image(images["player-male"],width/8,height/8-10,50,50,0,0,16,16);
      if(inputs.clickL){skin="player-male";}
    }else{
      image(images["player-male"],width/8,height/8,50,50,0,0,16,16);
    }
    if(this.box(width/8+55,height/8,50,50)){
      image(images["player-zombie"],width/8+55,height/8-10,50,50,0,0,16,16);
      if(inputs.clickL){skin="player-zombie";}
    }else{
      image(images["player-zombie"],width/8+55,height/8,50,50,0,0,16,16);
    }
    if(this.box(width/8+110,height/8,50,50)){
      image(images["player-man-5"],width/8+110,height/8-10,50,50,0,0,16,16);
      if(inputs.clickL){skin="player-man-5";}
    }else{
      image(images["player-man-5"],width/8+110,height/8,50,50,0,0,16,16);
    }
  }
  render_debug(){
    fill(255,255);
